# less complicated network nevertheless performs very well and has about
# 10x fewer parameters. Since I want this for the web, I don't want to have
# to download a 16 MB javascript file
import numpy as np
import pandas as pd
...
model.save("trained-model-keras-dense.hd5")
